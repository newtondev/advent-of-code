...
fn solve(input: String) -> (u32, u32) {
    ...
    for line in input.lines() {
        ...
        if cols[1] == "X" {
            // one: I should choose Rock | two: means I need to lose
            ...
            // one: I should choose Paper | two: means I need to end the round in a draw
            ...
            // Z -> one: I should choose Scissors | two: means I need to win
